...
class Video extends Component{
    ...
    render(){ 
        ...
        let [liked, setLiked] = this.useState('liked', false)
...
class ComponentExample extends Component{
    ...
    render(){ 
        let [search, setSearch] = this.useState('search', '')
         
          
      
        let [videos, setVideos] = this.useState('videos', [
        ...
        return `
            <div  class="mockup-browser border border-base-300 w-[400px] xl:w-[500px] ">
