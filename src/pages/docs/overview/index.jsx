...
class Installation extends Component {
  ...
  render() {
    let [saved, setSaved] = this.useState('saved', false)
      ...
      <div class='relative'>
        <div class="text-sm breadcrumbs">
          <ul>
            <li><a class='no-underline'
              onClick="${this.bind(`this.props?.swapPage({ page: 'getting-started', subpage: '' }); `, false, '2eo7r2pxpgf', "", null)}",
        ...
        <div class='flex mt-5 flex-col gap-5'>
          ...
          <div class="relative bg-base-100 border border-slate-200 rounded">
            <div class='flex gap-5 hero   p-4'>
              ...
              <div class="absolute end-5"
                ref="${copiedRef.bind}",
                onClick="${this.bind(`navigator.clipboard.writeText('npx vaderjs@latest --build'); setSaved(!saved, copiedRef.bind); setTimeout(() => {; setSaved(false, copiedRef.bind); }, 1000); `, false, '866j2muzxex', "setSaved,saved,copiedRef,", setSaved, saved, copiedRef)}",
              >
          ...
          <div class="relative bg-base-100 border border-slate-200 rounded">
            <div class='flex gap-5 hero   p-4'>
              ...
              <div class="absolute end-5"
                ref="${copiedRef.bind}",
                onClick="${this.bind(`navigator.clipboard.writeText(examples['1']); setSaved(!saved, copiedRef.bind); setTimeout(() => {; setSaved(false, copiedRef.bind); }, 1000); `, false, 'mjtgkejtiqo', "setSaved,saved,copiedRef,", setSaved, saved, copiedRef)}",
              >
                <div class='hover:bg-base-200 px-[.4rem] py-[.4rem] rounded'>
                  ${
                    saved ? `
        ...
        <div class='mt-12 absolute mb-6  flex flex-col gap-3'>
          ...
          <span
            ...
            onClick="${this.bind(`console.log(this); this.props?.swapPage({ page: 'getting-started', subpage: '' }); `, false, '15wayfr8dx7', "", null)}",
        ...
        <div class='mt-12 absolute mb-6 end-5  flex flex-col gap-3'>
          ...
          <span
            ...
            class='font-bold mb-12 hover:opacity-100 cursor-pointer opacity-60 '
            onClick="${this.bind(`console.log(this); this.props?.swapPage({ page: 'getting-started', subpage: 'project-structure' }); `, false, 'hiloxoq2su6', "", null)}",
    ...
    return `
      <div class='flex flex-col relative gap-5'>
        <div class="text-sm breadcrumbs">
          <ul>
            <li><a class='no-underline'
              onClick="${this.bind(`this.props?.swapPage({ page: 'getting-started', subpage: 'installation' }); `, false, 'rl0t9mqjjmo', "", null)}",
            >Installation</a></li>
          ...
          ` :
            `
              <div class='flex flex-col relative gap-5'>
                ...
                <p class="text-md">
                  Welcome to the vaderjs documentation.
                </p>
                <hr ></hr>
                ...
                <div class='mt-5  mb-6 flex flex-col gap-3'>
                  ...
                  <span
                    ...
                    onClick="${this.bind(`this.props?.click('getting-started', 'installation'); `, false, 'ot44shzcfr', "", null)}",
                  >Installation  </span>
                </div>
              </div>
