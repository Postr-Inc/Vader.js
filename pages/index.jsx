    ...
    render() {
        ...
        return `
           ...
           ${this.memoize(this.createComponent(Nav, {key:1}, [``,]))}
            <div class="p-2 "  >
                <div class="mt-5 flex flex-col w-full justify-center mx-auto xl:w-[36vw]  ">
                    <span class="badge badge-outline border-blue-500  text-blue-500 flex justify-center mx-auto badge-md badge-bottom-right">
                        Vaderjs ${window.Vader.version}
                    </span>
                    <h1
            ...
            text-black antialiased break-words capitalize drop-shadow-lg"
                    ...
                    <div class="text-center mx-auto  mt-24 justify-center flex flex-col  gap-5">
                        <h1 class="font-bold     mt-12 text-4xl">Create Interactive Webapps from Components</h1>
                        <p>
                    ...
                    class="btn btn-ghost  shadow border-slate-200 border  hover:bg-white btn-sm w-fit text-center align-middle mx-auto mt-5"
                        onClick="${this.bind(`setView(view === 'index' ? 'stackblitz' : 'index'); console.log(view); `, false, 'ryk3dl54irb', "setView,,view,,embedref,", setView, view, embedref)}"
                        >
                           ${
                    ...
                    class="${`mt-16 mb-16 flex xl:mx-auto xl:justify-center  md:mx-auto md:justify-center ${view !== "index" ? "p-5" : ""}   `}",>
                        ...
                        ${
                            ...
                            :  `
                             <embed 
                            ref="${embedref.bind}",
                            onLoad="${this.bind(``, false, 'c624l4a53p', "setLoaded,,loaded,", setLoaded, loaded)}"
